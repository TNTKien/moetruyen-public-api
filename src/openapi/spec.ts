      ...
      documentation: {
        info: {
          ...
          description: [
            ...
            "The include-based manga-family contract is now the default API shape.",
            "",
            "## Request notes",
            "",
            ...
            "## Versioning",
            "",
            "- `/v2` is the active public version where manga-family routes share a common base object and optional expansions.",
            "",
            "## Repositories",
            "",
